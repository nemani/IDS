...
class AttendanceDevice(BaseDevice):
    ...
    def send_message(self):
        ...
        message = self.create_message({'type': 'Tick', 'first': random.randrange(
            attendance_simulation[0][0][0], attendance_simulation[0][0][1]), 'second': random.randrange(attendance_simulation[0][1][0], attendance_simulation[0][1][1])})
